            ...
            t("#sa-basic").on("click",
                ...
                t("#sa-image").click(function() {
                    Swal.fire({
                        ...
                        imageUrl: "img/core-img/small-logo.png",
                        imageHeight: 50,
                        animation: !1,
                        confirmButtonClass: "btn btn-confirm mt-2"
                    })
                ...
                t("#custom-html-alert").click(function() {
                    Swal.fire({
                        ...
                        confirmButtonText: '<i class="fa fa-thumbs-o-up" aria-hidden="true"></i> Great!',
                        cancelButtonText: '<i class="fa fa-thumbs-o-down" aria-hidden="true"></i>'
                    })
                }),
